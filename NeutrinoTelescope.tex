...
\caption[As for Fig.~\ref{fig:NT:withoutIC} but including IceCube mock data]{As for Fig.~\ref{fig:NT:withoutIC} but including IceCube mock data. \todo{I might overlay the DD-only contours on here for comparison...}}
\label{fig:NT:withIC}
\end{figure}
