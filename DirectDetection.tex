...
\note{The form factor doesn't depend on the vector $\textbf{q}$ but on the scalar q...}
...
The full nuclear matrix elements can then be written in the form \todo{This expression isn't quite right - I'm missing a $\mu$ index - might need a factor of $s_\mu$ - I'll sort it out at some point...}
...
\todo{I could potentially add in a plot of some limits, depending on space/time.}
